...
export default createSelector([getListItems, getProductListSearch, getChangeSortBy, getChangeSortTypeBy], (listItems: Array<ExtendedProductListItem> = [], productListSearch: string, sortBy: SortValues, sortTypeBy: SortType) => {
